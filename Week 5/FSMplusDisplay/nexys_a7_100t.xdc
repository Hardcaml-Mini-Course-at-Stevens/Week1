...
set_property -dict { PACKAGE_PIN T10 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_set[0] } ];
set_property -dict { PACKAGE_PIN R10 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_set[1] } ];
set_property -dict { PACKAGE_PIN K16 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_set[2] } ];
set_property -dict { PACKAGE_PIN K13 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_set[3] } ];
set_property -dict { PACKAGE_PIN P15 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_set[4] } ];
set_property -dict { PACKAGE_PIN T11 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_set[5] } ];
set_property -dict { PACKAGE_PIN L18 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_set[6] } ];
set_property -dict { PACKAGE_PIN H15 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_set[7] } ];
set_property -dict { PACKAGE_PIN J17 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_sel_n[0] } ];
set_property -dict { PACKAGE_PIN J18 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_sel_n[1] } ];
set_property -dict { PACKAGE_PIN T9 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_sel_n[2] } ];
set_property -dict { PACKAGE_PIN J14 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_sel_n[3] } ];
set_property -dict { PACKAGE_PIN P14 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_sel_n[4] } ];
set_property -dict { PACKAGE_PIN T14 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_sel_n[5] } ];
set_property -dict { PACKAGE_PIN K2 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_sel_n[6] } ];
set_property -dict { PACKAGE_PIN U13 IOSTANDARD LVCMOS33 } [ get_ports { seven_seg_sel_n[7] } ];
